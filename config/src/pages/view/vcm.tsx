...
export function VCM() {
  ...
  useEffect(() => {
    const chamadaId = sessionStorage.getItem("CMID");
    if (chamadaId) {
  ...
  return (
    <section className="_body _turma _view">
      <Helmet>
        <title>Chamada do maternal • Sistema Kids | Ministério Kids</title>
        <meta name="title" content="Chamada do maternal • Sistema Kids | Ministério Kids" />
      </Helmet>
      <Header />
          ...
          <div className="_div">
            ...
            {isEditMode ? (
              <label className="_select" htmlFor="selprofessor">
                <Select className="camp" id="selprofessor" placeholder="Selecionar professor" name="Professor" title="Nome do professor" value={tempChamada ? tempChamada.Professor : ""} onChange={handleChamadaChange} required>
